'''
REPOSITORIO DO CODIGO DA TRANSFORMAÇÃO PYTHON
https://github.com/ivanpaulinodasilva/Codigo-da-Transformacao-Python.git

REPOSITORIO DO PROJETO DE PENSAMENTO COMPUTACIONAL
https://github.com/ivanpaulinodasilva/pensamento_computacional_projeto.git
